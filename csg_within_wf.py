...
# y_file_substr = "rsp"
# ...
X_DATA_DIR_NAME = imp_globals.x_data_dir_name
Y_DATA_DIR_NAME = imp_globals.y_data_dir_name
CANC_COL_NAME = imp_globals.canc_col_name
DRUG_COL_NAME = imp_globals.drug_col_name
GE_FNAME = imp_globals.ge_fname
SMILES_FNAME = imp_globals.smiles_fname
Y_FILE_SUBSTR = imp_globals.y_file_substr
# ----
...
RAW_DATA_DIR = MAIN_DATA_DIR/imp_globals.raw_data_dir_name
ML_DATA_DIR = MAIN_DATA_DIR/imp_globals.ml_data_dir_name
MODEL_DIR = MAIN_DATA_DIR/imp_globals.models_dir_name
INFER_DIR = MAIN_DATA_DIR/imp_globals.infer_dir_name
...
for source_data_name in data_sources:
    ...
    # TODO: Get the number of available splits
    sf = RAW_DATA_DIR/f"data.{source_data_name}"/splits_datadir_name
